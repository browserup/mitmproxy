...
class HarEntryRequest(BaseModel):
    ...
    headers: List[Header]
    query_string: List[HarEntryRequestQueryStringInner] = Field(alias="queryString")
    post_data: Optional[HarEntryRequestPostData] = Field(default=None, alias="postData")
    headers_size: StrictInt = Field(alias="headersSize")
    body_size: StrictInt = Field(alias="bodySize")
    comment: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["method", "url", "httpVersion", "cookies", "headers", "queryString", "postData", "headersSize", "bodySize", "comment"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.query_string:
            for _item_query_string in self.query_string:
                if _item_query_string:
                    _items.append(_item_query_string.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "queryString": [HarEntryRequestQueryStringInner.from_dict(_item) for _item in obj["queryString"]] if obj.get("queryString") is not None else None,
            "postData": HarEntryRequestPostData.from_dict(obj["postData"]) if obj.get("postData") is not None else None,
