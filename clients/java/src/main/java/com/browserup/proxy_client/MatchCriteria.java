...
public class MatchCriteria {
  ...
  public MatchCriteria url(@javax.annotation.Nullable String url) {
    this.url = url;
    return this;
  }
  ...
  public MatchCriteria page(@javax.annotation.Nullable String page) {
    this.page = page;
    return this;
  }
  ...
  public MatchCriteria status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public MatchCriteria content(@javax.annotation.Nullable String content) {
  ...
  public MatchCriteria contentType(@javax.annotation.Nullable String contentType) {
  ...
  public MatchCriteria websocketMessage(@javax.annotation.Nullable String websocketMessage) {
  ...
  public void setWebsocketMessage(@javax.annotation.Nullable String websocketMessage) {
    this.websocketMessage = websocketMessage;
  }


  public MatchCriteria requestHeader(@javax.annotation.Nullable NameValuePair requestHeader) {
  ...
  public void setRequestHeader(@javax.annotation.Nullable NameValuePair requestHeader) {
    this.requestHeader = requestHeader;
  }


  public MatchCriteria requestCookie(@javax.annotation.Nullable NameValuePair requestCookie) {
  ...
  public void setRequestCookie(@javax.annotation.Nullable NameValuePair requestCookie) {
    this.requestCookie = requestCookie;
  }


  public MatchCriteria responseHeader(@javax.annotation.Nullable NameValuePair responseHeader) {
  ...
  public void setResponseHeader(@javax.annotation.Nullable NameValuePair responseHeader) {
    this.responseHeader = responseHeader;
  }


  public MatchCriteria responseCookie(@javax.annotation.Nullable NameValuePair responseCookie) {
  ...
  public void setResponseCookie(@javax.annotation.Nullable NameValuePair responseCookie) {
    this.responseCookie = responseCookie;
  }


  public MatchCriteria jsonValid(@javax.annotation.Nullable Boolean jsonValid) {
  ...
  public void setJsonValid(@javax.annotation.Nullable Boolean jsonValid) {
    this.jsonValid = jsonValid;
  }


  public MatchCriteria jsonPath(@javax.annotation.Nullable String jsonPath) {
  ...
  public MatchCriteria jsonSchema(@javax.annotation.Nullable String jsonSchema) {
  ...
  public void setJsonSchema(@javax.annotation.Nullable String jsonSchema) {
    this.jsonSchema = jsonSchema;
  }


  public MatchCriteria errorIfNoTraffic(@javax.annotation.Nullable Boolean errorIfNoTraffic) {
  ...
  public void setErrorIfNoTraffic(@javax.annotation.Nullable Boolean errorIfNoTraffic) {
    this.errorIfNoTraffic = errorIfNoTraffic;
  }
