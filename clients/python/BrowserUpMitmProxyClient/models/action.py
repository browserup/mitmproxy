...
class Action(BaseModel):
    ...
    data_attributes: Optional[StrictStr] = Field(default=None, alias="dataAttributes")
    form_name: Optional[StrictStr] = Field(default=None, alias="formName")
    content: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "id", "className", "tagName", "xpath", "dataAttributes", "formName", "content"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "xpath": obj.get("xpath"),
            "dataAttributes": obj.get("dataAttributes"),
