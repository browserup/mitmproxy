...
public class HarEntryRequest {
  ...
  public HarEntryRequest method(@javax.annotation.Nonnull String method) {
    this.method = method;
    return this;
  }
  ...
  public HarEntryRequest url(@javax.annotation.Nonnull String url) {
    this.url = url;
    return this;
  }
  ...
  public HarEntryRequest httpVersion(@javax.annotation.Nonnull String httpVersion) {
  ...
  public HarEntryRequest cookies(@javax.annotation.Nonnull List<HarEntryRequestCookiesInner> cookies) {
  ...
  public HarEntryRequest headers(@javax.annotation.Nonnull List<Header> headers) {
  ...
  public HarEntryRequest queryString(@javax.annotation.Nonnull List<HarEntryRequestQueryStringInner> queryString) {
  ...
  public void setQueryString(@javax.annotation.Nonnull List<HarEntryRequestQueryStringInner> queryString) {
    this.queryString = queryString;
  }


  public HarEntryRequest postData(@javax.annotation.Nullable HarEntryRequestPostData postData) {
  ...
  public void setPostData(@javax.annotation.Nullable HarEntryRequestPostData postData) {
    this.postData = postData;
  }
  ...
  public HarEntryRequest bodySize(@javax.annotation.Nonnull Integer bodySize) {
  ...
  public HarEntryRequest comment(@javax.annotation.Nullable String comment) {
